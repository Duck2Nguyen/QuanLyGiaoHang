...
function ListOrderByStatus() {
    ...
    const handleChangePageIndex = (event: React.ChangeEvent<unknown>, value: number) => {
        setPage(value);
    };
    ...
    const getAllOrderByShipperId = async () => {
        const resp: any = await orderService.getAllOrderByShipperIdByPage(page, 5);
                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        {/* <Box mt={5} sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                            <Pagination count={10} onChange={handleChangePageIndex} />
                        </Box> */}
