...
public class CODService implements ICODService {
    ...
    public CODResponsePaging getCodDone(Integer page) {
        ...
        Page<CODEntity> codEntities = this.codRepository.findByShopIdAndStatusEqualsOrStatusEquals(shop.getId(), 2, 3, PageRequest.of(page-1, Integer.parseInt(Constans.CommonConstant.SIZE_PAGE.getSomeThing().toString())));
